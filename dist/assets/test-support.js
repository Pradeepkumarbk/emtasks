...
define('ember-cli-simple-store/test-support/qunit', ['exports', 'qunit'], function (exports, _qunit) {
  'use strict';
  ...
  var test = function test() {
    ...
    function wrapper(assert) {
      ...
      var env = assert.test.testEnvironment;
      run(function () {
        callback.apply(env, _arguments);
      });
    }

    // callback is original function 
    var callback = args.splice(1, 1, wrapper)[0];

    // args is fixed with new wrapper function
    _qunit.test.apply(null, args);
  };
