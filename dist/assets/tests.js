...
define('emtasks/tests/app.lint-test', [], function () {
  ...
  QUnit.test('controllers/mail.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/mail.js should pass ESLint\n\n');
  });
...
define('emtasks/tests/helpers/destroy-app', ['exports'], function (exports) {
  'use strict';
...
define('emtasks/tests/helpers/module-for-acceptance', ['exports', 'qunit', 'emtasks/tests/helpers/start-app', 'emtasks/tests/helpers/destroy-app'], function (exports, _qunit, _startApp, _destroyApp) {
  'use strict';
...
define('emtasks/tests/helpers/resolver', ['exports', 'emtasks/resolver', 'emtasks/config/environment'], function (exports, _resolver, _environment) {
  'use strict';
...
define('emtasks/tests/helpers/start-app', ['exports', 'emtasks/app', 'emtasks/config/environment'], function (exports, _app, _environment) {
  'use strict';
...
define('emtasks/tests/test-helper', ['emtasks/tests/helpers/resolver', 'ember-qunit', 'ember-cli-qunit'], function (_resolver, _emberQunit, _emberCliQunit) {
  'use strict';
...
define('emtasks/tests/unit/controllers/tasks-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('emtasks/tests/unit/controllers/tasks/new-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('emtasks/tests/unit/models/task-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('emtasks/tests/unit/routes/tasks-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('emtasks/tests/unit/routes/tasks/new-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
